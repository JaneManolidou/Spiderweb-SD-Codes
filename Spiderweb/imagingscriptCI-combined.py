...
bl_names = [
	a+'uid___A002_X101c3b2_X42b1_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X101e5ab_Xf704_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X10239e1_X178c7_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X10239e1_X181b9_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X10239e1_X18e80_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X10275c0_X17ff7_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X10305a2_X224e_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X10305a2_X2c6c_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X103317b_X20c5_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X103317b_X2744_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1033b6e_X153b_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1033b6e_X1bbd_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1033b6e_X21ed_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1033b6e_Xfe3_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1034414_X15fc_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1034414_X2139_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1034414_X27c9_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1034414_X2dbd_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1034f36_X119b_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1034f36_Xa80_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1035744_X2f7a_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1035744_X34cd_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1036d05_X2644_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1036d05_X2c62_newCI.ms.atmcor.atmtype_CI.bl/',
	a+'uid___A002_X1036d05_X33a5_newCI.ms.atmcor.atmtype_CI.bl/'
	]
...
for file in bl_names:
	outfile = b+ names[i] +'_CI_averaged'
...
for i, file in enumerate(bl_names2, start=1):
	outfile = troubleshooting + names[j] + f'_CI.png'
	j = j+1
...
while i <25:
	...
	i = i+1
outimage1 = expath + out + '_first_CI' + '.image.sd'
outimage2 = expath + out + '_second_CI'+ '.image.sd'
outimage3 = expath + out + '_third_CI'+ '.image.sd'
outimage4 = expath + out + '_fourth_CI' + '.image.sd'
outimage5 = expath + out + '_fifth_CI' + '.image.sd'
...
outimageA = expath + out + '_12A_CI' + '.image.sd'
outimageB = expath + out + '_12B_CI' + '.image.sd'
