...
ms_names = glob.glob('*_newCO.ms.atmcor.atmtype')
...
baseline_support = '0~1100'  # Channel range(s) to fit baseline
...
sfbeam = aU.sfBeam(frequency=frequency*1e-9,
                   ...
                   fwhmfactor=1.131,
                   diameter=12)[0]
out1 = f'{source}_spw{spw}_PM01.image.sd'
outimage1 = expath + out1
out2 = f'{source}_spw{spw}_PM02.image.sd'
outimage2 = expath + out2
out3 = f'{source}_spw{spw}_PM03.image.sd'
outimage3 = expath + out3
out4 = f'{source}_spw{spw}_PM04.image.sd'
outimage4 = expath + out4
#Concatenation:

print('Concatenating...')

concat(vis = ms_names, concatvis= 'Spiderweb_concatenated_Second_Try_CO.ms',respectname=True)
ms = 'Spiderweb_concatenated_Second_Try_CO.ms'
...
print("Averaging...", new)
outfile = b+ 'Spiderweb_concatenated_averaged_CO.ms.bl'
