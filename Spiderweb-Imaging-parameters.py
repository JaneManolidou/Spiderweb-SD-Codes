#defining the path to our files
path='/scratch/home/emanolid/data/Spiderweb/Data/science_goal.uid___A001_X2d20_X3bd9/group.uid___A001_X2d20_X3bda/member.uid___A001_X2d20_X3bdd/calibrated/working/'
...
#ALMA's Total Power Array uses 12 m telescopes
diameter=12
#With a listobs we find the spws in which we should be searching our lines
spwCO=19
spwCI = 21
#blank lists
mean_freq_CO=[]
...
for file in files_split:
	...
	#measuring theoretical fwhm for said frequency
