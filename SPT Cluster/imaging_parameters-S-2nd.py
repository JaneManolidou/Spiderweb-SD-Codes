path='/scratch/home/emanolid/data/SPT/2021.2.00019.S/science_goal.uid___A001_X15a9_X11e8/group.uid___A001_X15a9_X11e9/member.uid___A001_X15a9_X11ec/msfiles/'
...
for file in files_split:
	...
	theorybeam=au.primaryBeamArcsec(frequency=freq*1e-9,diameter=diameter,taper=10.0,fwhmfactor=None)
